...
func TestAdd(t *testing.T) {
	...
	for _, tc := range testCases { //_ is "blank indentifier"
...
func TestSqrtInvalid(t *testing.T) {
	...
	if err == nil {
		t.Error("Sqrt(-1): want error for invalid input, got nil") //t.Error instead of t.Error"f" means there's is no data in the message
	}
}
